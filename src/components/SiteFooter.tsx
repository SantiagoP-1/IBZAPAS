export function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-black/5 bg-zinc-50 dark:border-white/10 dark:bg-zinc-900">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 text-sm text-zinc-600 dark:text-zinc-400 sm:grid-cols-3 sm:px-6">
        <div>
          <h4 className="mb-2 font-semibold text-zinc-900 dark:text-zinc-50">Showroom</h4>
